...
st.caption('근대건축물은 특정 역사적 사건이나 사회적 변화와 연관되어 있습니다. 
            이러한 건물들은 특정 시기의 정치, 경제, 사회적 상황을 반영하며, 역사적인 연속성을 제공합니다. 
            보존을 통해 우리는 지난 시대의 중요한 순간들을 기억하고 연구할 수 있습니다.')
            
st.markdown('둘째, **역사적 중요성**을 지니기 때문에')
st.caption('근대건축물은 특정 역사적 사건이나 사회적 변화와 연관되어 있습니다. 
            이러한 건물들은 특정 시기의 정치, 경제, 사회적 상황을 반영하며, 역사적인 연속성을 제공합니다. 보존을 통해 우리는 지난 시대의 중요한 순간들을 기억하고 연구할 수 있습니다.')
...
st.caption('보존된 근대건축물은 창의적이고 지속 가능한 방식으로 재활용될 수 있습니다. 
            이는 지역의 관광자원이 될 뿐만 아니라 새로운 기능과 경제 활동을 유발하여 지속 가능한 발전에 기여합니다.')

st.markdown('다섯째, 미래세대를 위한 **유산**을 전달하기 위해')
st.caption('근대건축물을 보존함으로써 현재 세대의 책임으로서 미래 세대에게 유산을 전달합니다. 
            보존을 통해 다음 세대에게 역사, 문화, 예술적 가치를 이어주고, 그들이 과거의 경험을 이해하고 미래를 위한 창의적인 발전에 기여할 수 있도록 돕습니다.')
